...
const Home: React.FC = () => {
  return (
    <div className='flex justify-center items-center min-h-screen bg-[#26547C]'>
      ...
      <div className='relative flex-[70%] bg-white border-[1px] border-black'>
        ...
        <div className='relative w-full h-[calc(100%-120px)] overflow-y-auto overflow-x-hidden'>
          ...
          <div className='relative flex w-full my-[5px] ml-5 justify-start'>
            <p className='relative right-0 text-right max-w-[65%] p-[12px] bg-[#63A375] rounded-[10px]'>Hey, do you want to buy my products?</p>
          </div>
        </div>
