      ...
      <Header headerTop="visible">
        <div className={styles.FAQ}>
          <div className={styles.container} >
            ...
            <p>Contact our customer support team at [insert customer support email] within 7 days of receiving your order. Provide your order number, a brief description of the reason for return, and any supporting evidence such as photographs (if applicable).</p>
            <p>Our customer support team will review your request and provide you with a return authorization (RA) number and further instructions on how to proceed.0</p>
            <p>Once you receive the RA number, securely package the item(s) you wish to return, including the original invoice or a copy of it, and affix the provided return shipping label.</p>
            <p>Drop off your package at the designated shipping carrier or schedule a pickup. Please note that return shipping costs are the customer's responsibility, unless the return is due to an error on our part (e.g., incorrect item shipped, damaged or defective item).</p>
            <p>Once we receive your returned item(s) and verify their condition, we will process your refund or issue store credit within 7 business days. Refunds will be credited back to the original payment method used during the purchase.</p>
